...
<body class="background">
	...
	try {
		...
		String sql = "select participant.pid, participant.name, participant.email, participant.phone, participant.bid from participant";
	...
	<div>
        <form class="form" action="ParticipantUpdate" method="post">
            <div class="mb-3">
                <label for="pid" class="form-label">Participant ID to Update:</label>
                <input type="number" class="form-control input" name="pid" id="pid" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control input" name="phone" id="phone" required>
            </div>
